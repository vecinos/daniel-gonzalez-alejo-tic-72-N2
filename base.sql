...
insert  into `grupos`(`id`,`idusuario`,`idgrupo`) values (22,1,1);
...
insert  into `materia`(`id`,`nombre`,`avatar`,`orden`,`status`) values (1,'MATE','LO','L','1'),(2,'POO','no','no','1'),(3,'Android','no','n','1');
...
insert  into `usuario`(`idusuario`,`nombre`,`apellido_paterno`,`apellido_materno`,`telefono`,`calle`,`numero_externo`,`numero_interno`,`colonia`,`municipio`,`estado`,`CP`,`correo`,`usuario`,`contrasena`,`nivel`,`status`) values (1,'arturo','lara','garcia',2147483647,'cueducto sur',100,0,'ocoyoacac','ocoyoacac','mexico',52740,'forever_kigmail.cm','arturo','12345','3','1'),(2,'pacheco','eduardo','huerta',0,'',0,0,'','','',0,'','','','3','1'),(3,'juan','lara','garcia',0,'',0,0,'','','',0,'','','','3','1'),(4,'sandro','j','j',0,'',0,0,'','','',0,'','','','2','1'),(5,'julieta','n','n',0,'',0,0,'','','',0,'','','','2','1'),(6,'paco','p','p',0,'',0,0,'','','',0,'','','','2','1'),(7,'sandra','s','s',0,'',0,0,'','','',0,'','','','2','1'),(8,'ramon','r','r',0,'',0,0,'','','',0,'','','','2','1');
